...
**第六步 - 输出 JSON**
将上述全部分析写入 reason 字段，按【大盘】【板块】【个股】【策略】四段组织。

## 输出格式（仅输出此 JSON，不要在 JSON 外输出任何文字）
{{
    "signal": "buy",
    "confidence": 78,
    "reason": "【大盘】上证指数涨0.5%站上3300，量能放大，市场风偏回升，适合短线操作。【板块】农药板块今日涨幅4.2%排名第3，资金主攻农业方向；板块龙头为XX（涨停），{symbol}属于跟涨补涨标的，尚未充分反映利好。【个股】利多：与拜耳签订16亿合同+业绩暴增600%，5日线上穿20日线金叉，量价配合；利空：短期涨幅已超10%，RSI接近超买。【策略】建议回踩21.5买入，止损21.0（跌破20日线），目标22.5-23.0，仓位20%。",
    "stop_loss": 21.0,
    "take_profit": 23.0,
    "position_size": 0.2,
    "risk_level": "medium"
...
- signal 必须是 buy 或 sell（模拟盘禁止 hold）
- reason 必须包含【大盘】【板块】【个股】【策略】四段，每段至少一句话
